                                            ...
                                            <div className                        = "car-body p-md-5 mx-md-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class                    = "d-grid gap-2 mb-3 mt-5">
                                                        <button class             = "btn btn-light" type="button"  data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i className="fa fa-right-to-bracket orange"></i> Siguiente</button>
                                                    </div>
